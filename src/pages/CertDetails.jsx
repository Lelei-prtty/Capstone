...
import {
  ...
  Clock, Repeat, Target, Bookmark, CheckCircle2, ExternalLink,
} from 'lucide-react'
    ...
    return (
      <div className="min-h-screen bg-cream">
        ...
        <div className="mx-auto max-w-3xl px-5 py-16 text-center">
          ...
          <Link to="/recommendations" className="mt-4 inline-block text-sm font-medium text-navy underline underline-offset-2">
      ...
      <main className="mx-auto max-w-5xl px-5 py-8 sm:px-8">
        ...
        <div className="mt-5 rounded-2xl border border-ink-soft/10 bg-navy p-6 text-cream sm:p-8">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            {/* PRIMARY: Go to official certification site */}
            <a
              href={cert.url}
              target="_blank"
          ...
          <div className="space-y-7 lg:col-span-2">
            ...
            <div className="rounded-2xl border border-gold/20 bg-gold/5 p-5 flex items-center justify-between gap-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="focus-ring shrink-0 flex items-center gap-2 rounded-lg bg-navy px-4 py-2.5 text-sm font-medium text-cream hover:bg-navy/90"
              >
                <ExternalLink className="h-4 w-4" strokeWidth={1.75} />
                Visit official site
              </a>
          ...
          <aside className="space-y-5">
            ...
            <div className={'rounded-2xl border p-5 ' + (isFree ? 'border-sage/30 bg-sage-light' : 'border-coral/20 bg-coral-light')}>
              ...
              <p className="mt-1 text-xs text-ink-soft">
                {isFree ? 'No exam fee required for this certification.' : 'Exam fee payable directly to the provider.'}
              </p>
            </div>
          </aside>
        </div>
